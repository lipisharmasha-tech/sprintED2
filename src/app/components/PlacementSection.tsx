...
export function PlacementSection() {
  return (
    <section id="outcomes" className="bg-[#0f172a] py-16 sm:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12 sm:mb-16">
          {tracks.map((track, i) => (
            <div
              key={track.title}
              className="bg-[#1e293b] border border-white/5 rounded-2xl p-5 sm:p-6 space-y-3 hover:border-white/10 transition-all duration-300"
            >
              <div
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <h3 className="text-white text-2xl sm:text-3xl font-extrabold tracking-tight mb-6">
            ...
            <a
              href="#callback"
              className="inline-flex items-center gap-2 mt-6 sm:mt-8 bg-[#f97316] hover:bg-[#ea580c] text-white font-bold text-sm px-6 py-3.5 rounded-xl transition-all duration-200 shadow-[0_8px_20px_rgba(249,115,22,0.3)]"
            >
          ...
          <div className="bg-[#fff7ed] border border-[#fed7aa] rounded-2xl p-6 sm:p-8 space-y-5">
            <div className="w-12 h-12 bg-[#f97316] rounded-full flex items-center justify-center text-white">
              <CheckCircle size={22} />
            </div>
            <div>
              <h4 className="text-[#0f172a] font-extrabold text-lg sm:text-xl mb-3">Our Placement Assistance Commitment</h4>
              <p className="text-[#475569] text-sm leading-relaxed">
                If you complete all structural core assignments, deploy your functional data infrastructure architectures, and clear your programmatic interview milestones without landing a matching opportunity within 180 days, we continue working 1:1 with you until closure.
              </p>
            </div>
            <div className="bg-white border border-[#fed7aa] rounded-xl px-4 sm:px-5 py-3">
